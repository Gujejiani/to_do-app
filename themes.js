...
/////////////////// Theme Start ////////////////////////
export const choosingTheme = function choosingTheme() {
  const themes = document.querySelectorAll(".them");
  ...
  const removeChecked = (id) => {
    ...
    //checking if other themes are already checked and if so, removing img
    imgs.forEach((img) => {
